...
AdapterPoolMysql.prototype.save = function(data, cb) {
    var transporter = {
        ...
        params: [
            this.tableName,
            this.columnSystem, this.columnIdentity, this.columnCreateDate, this.columnObjectType, this.columnObjectIdentity, this.columnOldItem, this.columnNewItem,
            data.system, data.identity, data.createDate, data.objectType, data.objectIdentity, data.oldItem, data.newItem
        ],
        counter: 0,
        error: null
    };
